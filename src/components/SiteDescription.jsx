  ...
  return (
    <section className="mx-auto mt-16 max-w-5xl">
      <div className="mb-8 text-center">
        <h2 className="text-xs font-bold uppercase tracking-widest text-[#2C8179]">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {current.features.map((feature, index) => (
          <div
            key={index}
            className="group relative overflow-hidden rounded-2xl border border-glass bg-surface/60 p-6 shadow-sm backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[#2C8179]/40 hover:bg-surface/90 hover:shadow-glow-sm"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#2C8179]/10 text-[#2C8179] ring-1 ring-[#2C8179]/20 transition-transform duration-300 group-hover:scale-110">
            ...
            <h3 className="text-base font-bold text-primary transition-colors group-hover:text-[#2C8179]">
              {feature.title}
            </h3>
