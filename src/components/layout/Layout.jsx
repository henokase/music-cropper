...
export function Layout({ children }) {
  ...
  return (
    <div className="relative min-h-screen bg-base text-primary transition-colors duration-300 selection:bg-[#2C8179]/20 selection:text-[#2C8179]">
      {/* Background Decorative Ambient Glows */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden z-0">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[350px] rounded-full bg-gradient-to-tr from-[#2C8179]/10 via-[#2C8179]/5 to-transparent blur-3xl opacity-60 dark:opacity-40 animate-pulse-glow" />
        <div className="absolute top-1/3 -right-40 w-[500px] h-[500px] rounded-full bg-gradient-to-bl from-[#2C8179]/10 to-transparent blur-3xl opacity-40 dark:opacity-20" />
      </div>
      ...
      <header className="sticky top-0 z-40 glass-header">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          >
            <div className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-glass bg-surface/80 p-2 shadow-sm transition-all duration-300 group-hover:scale-105 group-hover:border-[#2C8179]/40 group-hover:shadow-glow-sm">
              <img src={waveIcon} alt="WaveCrop Logo" className="h-6 w-6 transition-transform duration-300 group-hover:rotate-6" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-lg font-bold tracking-tight text-[#2C8179] font-sans">
                  WaveCrop
                </span>
              </div>
          ...
          <div className="flex items-center gap-2.5">
            {isEditor && (
              <button
                ...
                className="flex items-center gap-2 rounded-xl border border-glass bg-surface/60 px-3.5 py-1.5 text-xs font-semibold text-secondary shadow-sm transition-all duration-200 hover:border-[#2C8179]/40 hover:bg-surface-hover hover:text-primary hover:shadow-glow-sm"
                aria-label="Replace audio"
              >
                <Upload className="h-3.5 w-3.5 text-[#2C8179]" />
      ...
      {isEditor && showModal && (
        ...
        >
          ...
          >
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#2C8179]/10 text-[#2C8179] ring-1 ring-[#2C8179]/20">
            ...
            <div className="mt-6 flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-gradient-to-r from-[#2C8179] to-[#2C8179] px-4 py-2 text-xs font-semibold text-white shadow-md shadow-[#2C8179]/20 transition-all hover:from-[#2C8179] hover:to-[#2C8179] hover:shadow-glow-sm"
              >
                Confirm & Replace
              </button>
            </div>
